...
class Persona {
   ...
   detalle() {
      let detalleo = {nombre: this.nombre, apellido: this.apellido, edad: this.edad, domicilio: this.domicilio};
      return detalleo
   }
}
...
function crearInstanciaPersona(nombre, apellido, edad, domicilio) {
   ...
   // Tu código:
   let newperson = new Persona (nombre, apellido, edad, domicilio);
   return newperson; 
}
